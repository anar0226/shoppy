...
exports.getKYCDocumentStats = exports.manualKYCCleanup = exports.cleanupKYCDocuments = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
// KYC Document Cleanup Function
// Automatically deletes KYC documents after 90 days for privacy compliance
exports.cleanupKYCDocuments = functions.pubsub
...
exports.manualKYCCleanup = functions.https.onCall(async (data, context) => {
    try {
...
exports.getKYCDocumentStats = functions.https.onCall(async (data, context) => {
    try {
        // Verify super admin access
        if (!context.auth) {
            throw new functions.https.HttpsError('unauthenticated', 'Authentication required');
...
//# sourceMappingURL=kyc-document-cleanup.js.map