...
exports.getPlatformStats = exports.listSuperAdmins = exports.createSuperAdmin = void 0;
 ...
 */
exports.listSuperAdmins = functions.https.onCall(async (data, context) => {
    var _a;
    try {
        ...
        if (!callerDoc.exists || !((_a = callerDoc.data()) === null || _a === void 0 ? void 0 : _a.isActive)) {
            throw new functions.https.HttpsError('permission-denied', 'Access denied');
        }
        const snapshot = await firestore.collection('super_admins').get();
        const admins = snapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
        return { admins };
    }
    catch (error) {
...
exports.getPlatformStats = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const activeUsers = usersSnapshot.docs.filter(doc => {
            var _a;
            const data = doc.data();
            const lastLogin = (_a = data.lastLoginAt) === null || _a === void 0 ? void 0 : _a.toDate();
...
//# sourceMappingURL=super-admin-setup.js.map