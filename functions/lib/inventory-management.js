...
exports.handleOrderStatusChange = exports.releaseInventoryForOrder = exports.reserveInventoryForOrder = void 0;
 ...
 */
exports.reserveInventoryForOrder = functions.https.onCall(async (data, context) => {
 ...
 */
exports.releaseInventoryForOrder = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
...
exports.handleOrderStatusChange = functions.firestore
    ...
    const shouldReleaseInventory = (afterData.status === 'cancelled' || afterData.status === 'failed') &&
