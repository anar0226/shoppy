 ...
 */
export const createSuperAdminSimple = functions.https.onCall(async (data, context) => {
  try {
    console.log('Starting super admin creation with data:', { email: data?.email, name: data?.name });
