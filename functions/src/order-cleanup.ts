 ...
 */
export const compressOldArchivedOrders = functions.pubsub
 ...
 */
export const deleteOldHistoricalOrders = functions.pubsub
 ...
 */
export const manualOrderCleanup = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    switch (action) {
      case 'archive':
        result = await archiveOldOrders({} as any);
        break;
      case 'compress':
        result = await compressOldArchivedOrders({} as any);
        break;
      case 'delete':
        result = await deleteOldHistoricalOrders({} as any);
        break;
      case 'all':
        result.archive = await archiveOldOrders({} as any);
        result.compress = await compressOldArchivedOrders({} as any);
        result.delete = await deleteOldHistoricalOrders({} as any);
        break;
      default:
...
// Helper functions
function createArchivedOrderData(originalData: any): any {
  return {
...
function createCompressedOrderData(archivedData: any): any {
  return {
...
function compressOrderItems(items: any[]): any[] {
