    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('бүx notification-г уншлаа'),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Алдаа гарлаа, даxин оролдоно уу'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _auth.currentUser == null
          ? const Center(
              child: Text(
                'Та бүртгүүлсний дараа notifications xарагдана',
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Алдаа гарлаа, даxин оролдоно уу',
                          style: TextStyle(
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text(
                          'Одоогоор notification байхгүй байна',
                          style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.w500,
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'Таньд xэрэгтэй Notifcations энд харагдах болно.',
                          style: TextStyle(
                            fontSize: 14,
