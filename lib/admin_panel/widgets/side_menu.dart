    ...
    try {
      ...
      if (snapshot.docs.isNotEmpty) {
        ...
        setState(() {
          ...
          _storeLogoUrl = storeData['logo'] as String?;
        });
      }
    } catch (e) {
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: _storeLogoUrl != null && _storeLogoUrl!.isNotEmpty
                        ? ClipRRect(
                            borderRadius: BorderRadius.circular(8),
                            child: Image.network(
                              _storeLogoUrl!,
          ...
          // Rest of the menu with theme-aware background
          Expanded(
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  _navItem(
                      context, Icons.inventory_2_outlined, 'Бүтээгдэхүүнүүд',
                      selected: widget.selected == 'Бүтээгдэхүүнүүд',
                      onTap: () {
                  ...
                  _navItem(context, Icons.account_balance_wallet,
                      'Төлбөрийн тохиргоо',
                      selected: widget.selected == 'Төлбөрийн тохиргоо',
                      onTap: () {
                  ...
                  _navItem(
                      context, Icons.local_offer_outlined, 'Хөнгөлөлтийн код',
                      selected: widget.selected == 'Хөнгөлөлтийн код',
                      onTap: () {
                  ...
                  _navItem(context, Icons.category, 'Бүтээгдэхүүний ангилал',
                      selected: widget.selected == 'Бүтээгдэхүүний ангилал',
                      onTap: () {
                    if (widget.selected != 'Бүтээгдэхүүний ангилал') {
                      if (widget.onPageSelected != null) {
                        ...
                        Navigator.of(context).pushReplacement(
                          MaterialPageRoute(
                              builder: (_) => const CategorizationPage()),
                        );
                      }
                    }
                  }),
                  ...
                  _navItem(
                      context, Icons.cleaning_services, 'Захиалгын цэвэрлэлт',
                      selected: widget.selected == 'Захиалгын цэвэрлэлт',
                      onTap: () {
