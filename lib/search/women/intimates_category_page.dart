...
class IntimatesCategoryPage extends StatefulWidget {
  const IntimatesCategoryPage({super.key});

  @override
  State<IntimatesCategoryPage> createState() => _IntimatesCategoryPageState();
}

class _IntimatesCategoryPageState extends State<IntimatesCategoryPage> {
  ...
  static const List<_SubCat> _subCats = [
    _SubCat('Bras', 'assets/images/categories/Women/intimates/bra.jpg',
        Color.fromARGB(255, 49, 47, 48)),
    _SubCat('Lingerie', 'assets/images/categories/Women/intimates/lingerie.jpg',
        Color.fromARGB(55, 230, 68, 154)),
    _SubCat(
        'Shapewear',
        'assets/images/categories/Women/intimates/shapewear.jpg',
        Color(0xFF8B4513)),
    _SubCat(
        'Underwear',
        'assets/images/categories/Women/intimates/underwear.jpg',
        Color(0xFFB8A082)),
  ];
    ...
    return MainScaffold(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.white,
          elevation: 0,
          title: const Text('Intimates', style: TextStyle(color: Colors.black)),
        ),
        body: SafeArea(
          child: ListView(
